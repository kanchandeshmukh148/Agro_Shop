    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <!-- Page Heading Start -->
                <div class="col-12 col-lg-auto mb-20 w-100 ">

                    <div class="box-head d-flex justify-content-between w-100 ">
                ...
                <div class="table-responsive">
                    <table class="table table-vertical-middle">
                        ...
                        <tbody>
                            ...
                            $result = $connect->query("SELECT * FROM product WHERE ShopID = '" . $_SESSION['ShopID'] . "' ");
