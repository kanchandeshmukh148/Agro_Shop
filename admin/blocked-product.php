                ...
                <div class="table-responsive">
                    <table class="table table-vertical-middle">
                        ...
                        <tbody>
                            ...
                            $result = $connect->query("SELECT * FROM product WHERE Productstateus = 'blocked';");
                            $count = 0;
                                    ...
                                    <tr>
                                        <td>
                                            <?php echo ++$count; ?>
                                                ...
                                                <td class="  ">
                                                    <div class=" d-inline ">
                                                        <a class="btn btn-primary " href="product-status-varify.php?id=<?php echo $row['ProductID'] ?>">Approve</a>
                                                    </div>
