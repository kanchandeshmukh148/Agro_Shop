            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3 class="title">Registered Products</h3>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-vertical-middle">
                        ...
                        <tbody>
                            ...
                            $result = $connect->query("SELECT * FROM product WHERE Productstateus = 'novarify';");
                            $count = 0;
                                        ...
                                        <td class="  ">
                                            <div class=" d-inline ">
                                                <a class="btn btn-primary "
                                                    href="product-status-varify.php?id3=<?php echo $row['ProductID'] ?>">Approve</a>
                                            </div>


                                            <div class=" d-inline ">
                                                <a class="btn btn-danger "
                                                    href="product-status-varify.php?id4=<?php echo $row['ProductID'] ?>">disapprove</a>
                                            </div>
                                        </td>
