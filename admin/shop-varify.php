            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3 class="title">Registered Shop</h3>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-vertical-middle">
                        ...
                        <tbody>
                            ...
                            $result = $connect->query("SELECT * FROM shop WHERE Shopstatus = 'novarify'");
                            $count = 0;
                                            ...
                                            <td>
                                                <div class=" d-flex gap-3">
                                                    ...
                                                    <a class="btn btn-primary "
                                                        href="shop-status-varify.php?id5=<?php echo $row['ShopID'] ?>">Approve </a>
                                                            </div>
                                                    
                                                            <div>
                                                                <a class="btn btn-danger " href="shop-status-varify.php?id7=<?php echo $row['ShopID'] ?>">Disapprove</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
