                        ...
                        <div class="QA_table mb_30 gap-5 col-12" style="display:flex; flex-wrap:wrap;">
                            <div class="col-12">
                                <table class="table col-12">
                                    ...
                                    <tbody>
                                        <?php $count = 0 ; while ($areaRow = mysqli_fetch_assoc($areaResult)) { ?>
                                            <tr>
                                                <td>
                                                    <?php echo ++$count ?>
                                                </td>
                            ...
                            <form method="POST" action="edit-area.php?id=<?php echo $areaRow['area-id'] ?>">
                                <div class="row mbn-20">
                                    <div class="col-6 mb-20">
                                        ...
                                        <select class="form-control" id="stateId<?php echo $areaRow['area-id']; ?>" name="stateId" required>
                                    ...
                                    <div class="col-6 mb-20">
                                        ...
                                        <select class="form-control" id="cityId<?php echo $areaRow['area-id']; ?>" name="cityId" required>
                                    ...
                                    <div class="col-12 mb-20">
                                        ...
                                        <textarea type="text" id="formLayoutUsername1" class="form-control"
                                            placeholder="Addres--" name="areaAddress"><?php echo $areaRow['area-address'] ?></textarea>
                                    </div>
